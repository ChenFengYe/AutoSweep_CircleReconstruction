...
namespace PolygonDecompose
{
	public class CPolygon
	{
		...
		public CPolygon(Vector2d[] points)
		{
			...
			{
				m_aVertices = new Vector2d[nNumOfPoitns];
		...
		/***********************************
		 ...
		 it will return -1 
		 ***********************************/
		public int VertexIndex(Vector2d vertex)
		{
			int nIndex = -1;
		...
		/***********************************
		 ...
		 it will return null; 
		 ***********************************/
		public Vector2d PreviousPoint(Vector2d vertex)
		{
			int nIndex;
		...
		/***************************************
			 ...
			 it will return null; 
		***************************************/
		public Vector2d NextPoint(Vector2d vertex)
		{
		...
		*******************************************/
		public static double PolygonArea(Vector2d[] points)
		{
			double dblArea = 0;
		...
		************************************************/
		public VertexType PolygonVertexType(Vector2d vertex)
		{
			...
			{
				Vector2d pti = vertex;
				Vector2d ptj = PreviousPoint(vertex);
				Vector2d ptk = NextPoint(vertex);

				double dArea = PolygonArea(new Vector2d[] { ptj, pti, ptk });
		...
		/geometry/lineline2d
		*********************************************/
		public bool Diagonal(Vector2d vertex1, Vector2d vertex2)
		{
		...
		*********************************************************/
		public bool PrincipalVertex(Vector2d vertex)
		{
			bool bPrincipal = false;
			if (PolygonVertex(vertex)) //valid vertex
			{
				Vector2d pt1 = PreviousPoint(vertex);
				Vector2d pt2 = NextPoint(vertex);
		...
		**********************************************/
		public bool PolygonVertex(Vector2d point)
		{
			bool bVertex = false;
		...
		******************************************************/
		public void ReverseVerticesDirection()
		{
			...
			Vector2d[] aTempPts = new Vector2d[nVertices];
		...
		*****************************************/
			...
			Vector2d[] points)
		{
			...
			for (int i = 0; i < nPoints; i++)
			{
				...
				if (crossProduct == 0)
				{
					Vector2d v = (points[j] + points[k]) / 2;
