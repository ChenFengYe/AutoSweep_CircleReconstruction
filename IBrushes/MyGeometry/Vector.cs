...
namespace MyGeometry
{
    ...
    public struct MyVector3
    {
        ...
        static public bool operator ==(MyVector3 v1, MyVector3 v2)
        {
            return (Math.Abs(v1.x - v2.x) < 0.00000001 && Math.Abs(v1.y - v2.y) < 0.00000001 && Math.Abs(v1.z - v2.z) < 0.00000001);
        ...
        static public double Distance(MyVector3 a, MyVector3 b)
        {
            return (a - b).Length();
        }
