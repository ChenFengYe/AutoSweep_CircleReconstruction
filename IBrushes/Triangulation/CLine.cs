...
namespace PolygonDecompose
{
	public class CLine
	{
		...
		private void Initialize(Double angleInRad, MyVector2 point)
		{
		...
		public CLine(Double angleInRad, MyVector2 point)
		{
			Initialize(angleInRad, point);
		}

		public CLine(MyVector2 point1, MyVector2 point2)
		{
		 ...
		 * ************************************/
		public MyVector2 IntersectionWith(CLine line)
		{
			MyVector2 point = new MyVector2();
			double a1 = this.a;
			double b1 = this.b;
			double c1 = this.c;
	...
	public class CLineSegment : CLine
	{
		...
		private MyVector2 m_startPoint;
		private MyVector2 m_endPoint;

		public MyVector2 StartPoint
		{
			get
			{
				return m_startPoint;
		...
		public CLineSegment(MyVector2 startPoint, MyVector2 endPoint)
		...
		public bool PointInLine(MyVector2 v)
		{
			bool bInline = false;
